        ...
        <header class="header" id="header">
            <nav class="nav container">
                <a href="{{ route('homepage') }}" class="nav__logo"
                    >TRAVEL<i class="bx bxs-map"></i>BOOK</a
                >
        ...
        <footer class="footer section">
            <div class="footer__container container grid">
                <div>
                    ...
                    TRAVEL<i class="bx bxs-map"></i> BOOK
                    </a>
                ...
                <div class="footer__content">
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li>
                                <a href="#" class="footer__link">Layanan</a>
                            </li>
                            <li>
                                <a href="#" class="footer__link">Berita & Artikel</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li>
                                <a href="#" class="footer__link">Lokasi Kami</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li>
                                <a href="#" class="footer__link"> Kontak Kami</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="footer__info container">
                <span class="footer__copy">
                    &#169; TravelBook. All rigths reserved
                </span>
